...
Examples:
    python run_monthly_week_sensitivity.py --select-only
    python run_monthly_week_sensitivity.py --case baseline
    python run_monthly_week_sensitivity.py --case central
    python run_monthly_week_sensitivity.py --case ups_min
"""
