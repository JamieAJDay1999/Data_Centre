...
\IEEEaftertitletext{%
  ...
  \begin{itemize}
    ...
    \HighlightItem{Recovery-certified flexibility reaches 9.75 hours on a typical day.}
...
energy storage (TES) for a 1 MW data centre. Physical states and unfinished
...
reduces 2025 electricity cost from GBP~550,503.59 to GBP~522,707.23, a saving of
5.049\%. Full-year endpoints rank flexible workload as the most influential
...
Each request begins from the stored annual state, follows the annual pre-event
CPU trajectory and must recover storage and thermal states after the event.
The resulting duration envelope is strongly time- and direction-dependent:
increased import is sustained for up to 9.75 hours at +25 kW, whereas reduced
import is sustained for up to 5.25 hours at -100 and -150 kW.
...
283 have exact duration boundaries and five retain explicitly marked certified
