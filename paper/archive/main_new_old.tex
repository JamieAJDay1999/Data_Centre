...
resetting the facility at midnight. From the completed annual trajectory the
study then quantifies annual cost value, tests full-year sensitivity endpoints
for the three internal flexibility resources, and applies a
recovery-constrained duration assessment to an objectively selected
representative day.
...
cooling power and TES state, solved as a complete 2025 rolling chain with
explicit state, workload, solver and settlement audits; (2) five-point full-year
sensitivity evidence ranking flexible workload, UPS capacity and TES capacity;
and (3) a recovery-certified flexibility assessment that maps the maximum
sustainable duration of a requested grid-power deviation from the stored annual
state, and decomposes each response into its IT, cooling, TES and UPS
contributions.

The remainder of this paper reviews the literature, defines the linked annual
method and benchmark, and presents the annual results, the sensitivity endpoints
and the recovery-certified representative-day flexibility assessment.
