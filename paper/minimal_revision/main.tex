...
%DIF DEL C:\GitHub\Data_Centre\paper\minimal_revision\build\original_markup\old.tex   Wed Sep  9 19:53:01 2026
%DIF ADD C:\GitHub\Data_Centre\paper\minimal_revision\build\original_markup\new.tex   Wed Sep  9 19:53:01 2026
...
\expandafter\def\csname originalref@NG2017SNAPS\endcsname{1}
...
\author{ \DIFaddbegin \DIFadd{James Day\textsuperscript{1}, }\DIFaddend Mehmet Turker Takci\textsuperscript{1},  and Meysam Qadrdan\textsuperscript{1}}
...
\IEEEaftertitletext{%
  ...
  \begin{itemize}
    ...
    \HighlightItem{Integrated IT/UPS/cooling model developed for a data centre.}
     \DIFaddbegin \HighlightItem{\DIFadd{Cost-optimised operation cuts annual electricity costs by 5.05\%.}}
...
\begin{table}[!t]
\centering
\caption{Hourly  \DIFaddbeginFL \DIFaddFL{Mean Tranche Shares in the Adopted Quarter-Hour Inputs }\DIFaddendFL (\%)}
\label{tab:shiftable}
...
\midrule
$k=1$ & 0 $\leq$ 30 min & 27.50 & 23.25 & 29.25 & 45.00 & 31.25 & 18.75 & 27.50 & 23.25 & 29.25 & 45.00 & 31.25 & 18.75 & 27.50 & 23.25 & 29.25 & 45.00 & 31.25 & 18.75 & 27.50 & 23.25 & 29.25 & 45.00 & 31.25 & 18.75 \\
$k=2$ & 0 $\leq$ 60 min & 20.50 & 20.75 & 18.50 & 22.50 & 18.75 & 16.50 & 20.50 & 20.75 & 18.50 & 22.50 & 18.75 & 16.50 & 20.50 & 20.75 & 18.50 & 22.50 & 18.75 & 16.50 & 20.50 & 20.75 & 18.50 & 22.50 & 18.75 & 16.50 \\
$k=3$ & 0 $\leq$ 2 h & 18.25 & 15.00 & 14.25 & 17.50 & 22.50 & 23.50 & 18.25 & 15.00 & 14.25 & 17.50 & 22.50 & 23.50 & 18.25 & 15.00 & 14.25 & 17.50 & 22.50 & 23.50 & 18.25 & 15.00 & 14.25 & 17.50 & 22.50 & 23.50 \\
$k=4$ & 0 $\leq$ 3 h & 33.75 & 41.00 & 38.00 & 15.00 & 27.50 & 41.25 & 33.75 & 41.00 & 38.00 & 15.00 & 27.50 & 41.25 & 33.75 & 41.00 & 38.00 & 15.00 & 27.50 & 41.25 & 33.75 & 41.00 & 38.00 & 15.00 & 27.50 & 41.25 \\
\bottomrule
\end{tabular}%
}
\DIFaddendFL \end{scriptsize}
...
Table~\ref{tab:shiftable} presents  \DIFaddbegin \DIFadd{hourly mean shares }\DIFaddend of flexible workloads across  \DIFaddbegin \DIFadd{the four delay tranches: tranche $k=1$ permits a final execution-interval start }\DIFaddend 30 minutes  \DIFaddbegin \DIFadd{after arrival, $k=2$ }\DIFaddend 60 minutes,  \DIFaddbegin \DIFadd{$k=3$ }\DIFaddend 2 hours, and  \DIFaddbegin \DIFadd{$k=4$ }\DIFaddend 3 hours . The percentages represent the relative distribution within the flexible workload.  \DIFaddbegin \DIFadd{The solver uses the recorded quarter-hour fractions, rather than expanding these hourly means. Figure~\ref{fig:workload_ratios} shows the flexible and inflexible arrival utilisation. Together these profiles capture }\DIFaddend the time-dependent and duration-sensitive  \DIFaddbegin \DIFadd{workload assumptions. A final eligible interval closes 15 minutes after its start: for example, a three-hour class arriving at noon may execute in the interval 15:00--15:15. Thus the class names denote deferral between interval starts, not continuous-time completion deadlines}\DIFaddend .
...
Figure~\ref{fig:flex_duration_hourly_heatmap} illustrates significant variations in flexibility duration $\tau$ with start time $t_0$ and deviation $\Delta P$.  \DIFaddbegin \DIFadd{A 100 kW upward request can be sustained for 1.25 h from 06}\DIFaddend :00  \DIFaddbegin \DIFadd{and 6 h from noon; a 150 kW reduction also lasts 6 h from noon. A 25 kW downward request reaches the twelve-hour assessment cap at 03}\DIFaddend :\DIFaddbegin \DIFadd{00, 10:}\DIFaddend 00 \DIFaddbegin \DIFadd{, 11:00 and 12}\DIFaddend : \DIFaddbegin \DIFadd{00. These changes reflect the specific baseline from which flexibility is provided: storage energy, unfinished work and thermal conditions differ between starts despite unchanged installed capacities.
...
\DIFaddFL{IT electrical demand }& \DIFaddFL{407,653 }& \DIFaddFL{392,409 }& \DIFaddFL{-15,244 }\\
\DIFaddFL{CRAC chiller }& \DIFaddFL{105,337 }& \DIFaddFL{91,252 }& \DIFaddFL{-14,084 }\\
\DIFaddFL{TES charging chiller }& \DIFaddFL{0 }& \DIFaddFL{6,903 }& \DIFaddFL{+6,903 }\\
\DIFaddFL{UPS net grid effect }& \DIFaddFL{0 }& \DIFaddFL{-5,376 }& \DIFaddFL{-5,376 }\\
\DIFaddFL{Auxiliary overhead }& \DIFaddFL{37,514 }& \DIFaddFL{37,514 }& \DIFaddFL{+0 }\\
\DIFaddFL{Total settlement cost }& \DIFaddFL{550,504 }& \DIFaddFL{522,703 }& \DIFaddFL{-27,801 }\\
\bottomrule\end{tabular}
\end{table*}

\subsection{\DIFadd{Sensitivity Analysis}}\label{sec:sensitivity}
\DIFadd{Figure~\ref{fig:sensitivity_tornado} summarises the OAT sensitivity analysis described in Section~\ref{sec:sensitivity-design} using the full-year electricity-cost saving. The base case yields a 5.05\% saving; each curve shows the response when the corresponding resource parameter is varied between $0.5\times$ and $1.5\times$ its base value. All intermediate points are completed annual runs.
