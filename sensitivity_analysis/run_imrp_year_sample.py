...
Default trial (50 evenly spaced standard days from 2025):
    ...
    python -m sensitivity_analysis.run_imrp_year_sample

Useful supporting commands:

    python -m sensitivity_analysis.run_imrp_year_sample --dry-run
    python -m sensitivity_analysis.run_imrp_year_sample --sample-days 2
    python -m sensitivity_analysis.run_imrp_year_sample --report-only
...
Full standard-day year after the trial is accepted:
    ...
    python -m sensitivity_analysis.run_imrp_year_sample --sample-days all
"""
...
def configure_existing_pipeline(horizons: dict[str, np.ndarray], output_root: Path) -> ModuleType:
    ...
    from . import sensitivity_sweep as sweep
