...
Usage (from the repo root):
    python -m sensitivity_analysis.sensitivity_sweep --tier 1
    python -m sensitivity_analysis.sensitivity_sweep --tier 2
    python -m sensitivity_analysis.sensitivity_sweep --tier 2 --jobs 4
    python -m sensitivity_analysis.sensitivity_sweep --tier 1 --dry-run
    python -m sensitivity_analysis.sensitivity_sweep --tier 1 --only tes
...
def main():
    ...
    print("Next: python -m sensitivity_analysis.plot_sensitivity_results")
